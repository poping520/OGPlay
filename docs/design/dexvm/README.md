...
开发的长期上下文根节点）。架构方向已由 [ADR-0017](../../adr/dexvm.md#adr-0017)
...
- 本方案**不改变**项目的元规范：AGENTS.md 的工作流约束（WU 有界、机器可判定
  测试、能力记账、明确失败、结构化日志）对 dexvm 全部适用。
...
| [16 · 音频审计与开发规划](16-audio.md) | 应用音频语义、BootDex 选择、OpenSL/混音/时钟/退出、CLI 职责收敛与逐批验收；AUD-01 完成，AUD-02/03 未开始 |
