...
更新：2026-08-16 · M10 Layout UI LUI-1..7 已完成，typed AXML、UiTree、inflater、
Frame/Linear layout 与 RGBA renderer 已闭合；macOS SDL 事件泵已隔离 DexVM GLThread；DVM-31 EGL façade 实现完成，
...
- **M10 Layout UI LUI-1..7 已完成**：compiled AXML 已是 generic typed 输出；
  ...
  RGBA overlay 并缓存。下一步 LUI-8 在
  session present 边界合成 base/video/UI。
