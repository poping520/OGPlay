...
更新：2026-08-16 · M10 Layout UI LUI-1..6 已完成，typed AXML、UiTree、DexVM binding、
inflater、Frame/Horizontal LinearLayout 已闭合；macOS SDL 事件泵已隔离 DexVM GLThread；DVM-31 EGL façade 实现完成，
...
- **M10 Layout UI LUI-1..6 已完成**：compiled AXML 已是 generic typed 输出；
  ...
  wrap measure，旧 edge-row bounds 特判已删除。下一步 LUI-7 deterministic RGBA overlay。
