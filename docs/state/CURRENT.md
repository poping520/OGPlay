...
更新：2026-08-16 · M10 Layout UI LUI-1..10 已完成，Asphalt 6 启动视频 skip UI
...
- **M10 Layout UI LUI-1..10 已完成**：typed AXML → inflater → 唯一 UiTree/View binding →
  ...
  帧的三轮 scenario 均 passed/no fault/clean shutdown。下一步 LUI-11 通用 LinearLayout
  与动态 hierarchy。
...
能力现状以 `capabilities.toml` 为准。macOS/arm64 最近 full CTest 745/745；
