...
更新：2026-08-16 · M10 Layout UI LUI-1..4 已完成，typed AXML、UiTree、DexVM binding
与 registry inflater/merge 已闭合；macOS SDL 事件泵已隔离 DexVM GLThread；DVM-31 EGL façade 实现完成，
...
- **M10 Layout UI LUI-1..4 已完成**：compiled AXML 已是 generic typed 输出；
  ...
  Activity switch 清理旧 content generation。下一步 LUI-5 正式 measure/layout FrameLayout。
