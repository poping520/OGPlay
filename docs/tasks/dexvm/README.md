...
| WU | 一句话目标 | 状态 |
| --- | --- | --- |
| [DVM-189](DVM-189.md) | 音频协议、BootDex 与会话输出收敛（AUD-01..03，两个实现单元加集中验收） | 规划完成，未实施 |
...
| [DVM-159](DVM-159.md) | AudioTrack notification 状态 getter | 完成 |
| [DVM-160](DVM-160.md) | SystemClock 设备 boot-age 起点 | 完成 |
| [DVM-161](DVM-161.md) | Settings 公开 API 迁入 BootDex | 完成 |
| [DVM-162](DVM-162.md) | Context calling/self 权限家族 | 完成 |
| [DVM-164](DVM-164.md) | URLConnection BootDex 与禁用网络边界 | 完成 |
...
| [DVM-182](DVM-182.md) | Class.getEnumConstants 浅克隆共享枚举常量 | 完成 |
...
| [DVM-53](DVM-53.md) | FastCode 预解码构建器 | 完成 |
| [DVM-54](DVM-54.md) | Threaded 全 bridge 后端骨架 | 完成 |
...
| [DVM-98](DVM-98.md) | 平台 intrinsic enum 声明生成器 | 已完成 |
...
| [DVM-110](DVM-110.md) | ScheduledThreadPoolExecutor 与 FutureTask 迁入 BootDex | 已完成 |
| [DVM-111](DVM-111.md) | JNI 对象数组的接口可赋值关系 | 已完成 |
...
| [DVM-130](DVM-130.md) | JNI 平台入口统一进入 DexVM | 完成 |
...
| [DVM-135](DVM-135.md) | View 主线程 Runnable 投递 | 完成 |
| [DVM-136](DVM-136.md) | API 19 OrientationEventListener | 完成 |
...
| [DVM-150](DVM-150.md) | Runtime shutdown hook 与显式退出闭环 | 完成 |
