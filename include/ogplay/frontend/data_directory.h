...
// Resolves a complete launcher/runtime payload beside the executable, then in
// a macOS bundle Resources directory, and finally in the development source
// tree when supplied. Incomplete candidates are never published.
