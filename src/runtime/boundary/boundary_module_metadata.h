...
#define OGPLAY_ANDROID_BOUNDARY_EXPORTS(X)                                      \
    ...
    X("AConfiguration_delete", 1, 1, ReturnZero)                               \
    X("AConfiguration_fromAssetManager", 2, 2, ReturnZero)                     \
    X("AConfiguration_getLanguage", 3, 2, ConfigurationGetLocale)              \
    X("AConfiguration_getCountry", 4, 2, ConfigurationGetLocale)               \
    ...
    X("AInputQueue_detachLooper", 9, 1, ReturnZero)                            \
    X("AInputQueue_getEvent", 10, 2, InputQueueGetEvent)                       \
    X("AInputQueue_preDispatchEvent", 11, 2, ReturnZero)                       \
    ...
    X("ANativeWindow_setBuffersGeometry", 19, 4, ReturnZero)
...
#define OGPLAY_EGL_BOUNDARY_EXPORTS(X)                                          \
    ...
    X("eglDestroyContext", 9, 2, ReturnOne)                                    \
    X("eglDestroySurface", 10, 2, ReturnOne)                                   \
    X("eglTerminate", 11, 1, Terminate)

#define OGPLAY_LOG_BOUNDARY_EXPORTS(X)                                          \
    X("__android_log_print", 0, 3, Write)                                      \
