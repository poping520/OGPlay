...
namespace ogplay::runtime::dexvm::intrinsics {
    ...
    namespace {
        ...
        // Nested types and java.lang.annotation.* are declared by their owning
        // families rather than this top-level interface catalog.
...
void AddNumberConversions(IntrinsicClassBuilder& builder, bool wide,
    ...
    builder.OverrideMethod("byteValue", "()B", [numeric, kind](IntrinsicContext& c) {
...
void AddSmallIntegralCommon(IntrinsicClassBuilder& builder,
    ...
    builder.FinalOverrideMethod("hashCode", "()I", [](IntrinsicContext& c) {
        return VmValue::Int(static_cast<T>(ReadBoxed(c, c.receiver, false))); });
    builder.FinalOverrideMethod("toString", "()Ljava/lang/String;", [](IntrinsicContext& c) {
...
void AddWideIntegralCommon(IntrinsicClassBuilder& builder,
    ...
    builder.StaticMethod("compare", std::string("(") + primitive + primitive + ")I",
        ...
        return VmValue::Int(left < right ? -1 : (left > right ? 1 : 0)); });
    builder.FinalOverrideMethod("equals", "(Ljava/lang/Object;)Z", [descriptor](IntrinsicContext& c) {
        return Bool(IsExactClass(c, c.arguments[0].ref, descriptor) &&
...
IntrinsicClassDecl Declare_java_lang_Boolean() {
    ...
    builder.FinalOverrideMethod("equals", "(Ljava/lang/Object;)Z", [](IntrinsicContext& c) { return Bool(IsExactClass(c, c.arguments[0].ref, "Ljava/lang/Boolean;") && ReadBoxed(c, c.receiver, false) == ReadBoxed(c, c.arguments[0].ref, false)); });
    builder.FinalOverrideMethod("hashCode", "()I", [](IntrinsicContext& c) { return VmValue::Int(ReadBoxed(c, c.receiver, false) != 0 ? 1231 : 1237); });
    builder.FinalOverrideMethod("toString", "()Ljava/lang/String;", [](IntrinsicContext& c) { return Make(c, ReadBoxed(c, c.receiver, false) != 0 ? u"true" : u"false"); });
...
IntrinsicClassDecl Declare_java_lang_Character() {
    ...
    builder.FinalOverrideMethod("equals", "(Ljava/lang/Object;)Z", [](IntrinsicContext& c) { return Bool(IsExactClass(c, c.arguments[0].ref, "Ljava/lang/Character;") && ReadBoxed(c, c.receiver, false) == ReadBoxed(c, c.arguments[0].ref, false)); });
    builder.FinalOverrideMethod("hashCode", "()I", [](IntrinsicContext& c) { return VmValue::Int(static_cast<std::uint16_t>(ReadBoxed(c, c.receiver, false))); });
    builder.FinalOverrideMethod("toString", "()Ljava/lang/String;", [](IntrinsicContext& c) { return Make(c, std::u16string(1, static_cast<char16_t>(ReadBoxed(c, c.receiver, false)))); });
...
VmValue InvokeGuestDirect(Interpreter& vm, const char* owner, const char* name,
...
VmValue FormatWithFormatter(IntrinsicContext& context, const VmObjectRef locale,
                            const VmObjectRef format,
                            const VmObjectRef arguments) {
    if (!format.IsValid()) {
        throw VmJavaThrow{"Ljava/lang/NullPointerException;", "format == null"};
    }
    auto& vm = context.vm;
    const auto input_roots = vm.ProtectReferences(
        std::array{locale, format, arguments});
    const auto argument_count = arguments.IsValid()
                                    ? vm.Model().ArrayLength(arguments)
                                    : 0;
    const auto capacity = static_cast<std::int32_t>(
        Value(context, format).size() +
        static_cast<std::size_t>(argument_count) * 10U);
    const auto builder = vm.NewIntrinsicInstance("Ljava/lang/StringBuilder;");
    const auto builder_roots = vm.ProtectReferences(
        std::array{locale, format, arguments, builder});
    InvokeGuestDirect(vm, "Ljava/lang/StringBuilder;", "<init>", "(I)V",
                      {VmValue::Ref(builder), VmValue::Int(capacity)});
    const auto formatter = vm.NewIntrinsicInstance("Ljava/util/Formatter;");
    const auto formatter_roots = vm.ProtectReferences(
        std::array{locale, format, arguments, builder, formatter});
    InvokeGuestDirect(
        vm, "Ljava/util/Formatter;", "<init>",
        "(Ljava/lang/Appendable;Ljava/util/Locale;)V",
        {VmValue::Ref(formatter), VmValue::Ref(builder), VmValue::Ref(locale)});
    const auto formatted = InvokeGuest(
        vm, formatter, "format",
        "(Ljava/lang/String;[Ljava/lang/Object;)Ljava/util/Formatter;",
        {VmValue::Ref(format), VmValue::Ref(arguments)}).ref;
    const auto result_roots = vm.ProtectReferences(
        std::array{builder, formatter, formatted});
    return InvokeGuest(vm, formatted, "toString", "()Ljava/lang/String;");
}
...
IntrinsicClassDecl Declare_java_lang_String() {
    ...
    builder.FinalMethod("lastIndexOf", "(II)I",
        [](IntrinsicContext& context) {
            const auto haystack = Value(context, context.receiver);
            const auto from = context.arguments[1].AsInt();
            if (from < 0 || haystack.empty()) return VmValue::Int(-1);
            const auto start = std::min<std::size_t>(
                static_cast<std::size_t>(from), haystack.size() - 1U);
            const auto found = haystack.rfind(static_cast<char16_t>(
                context.arguments[0].cat1 & 0xffffU), start);
            return VmValue::Int(found == std::u16string::npos
                                    ? -1
                                    : static_cast<std::int32_t>(found));
        });
    ...
    builder.FinalMethod("subSequence", "(II)Ljava/lang/CharSequence;",
        [](IntrinsicContext& context) {
            return InvokeGuest(context.vm, context.receiver, "substring", "(II)Ljava/lang/String;",
    ...
    builder.StaticMethod(
        ...
        [](IntrinsicContext& context) {
            const auto locale = InvokeGuestStatic(
                context.vm, "Ljava/util/Locale;", "getDefault",
                "()Ljava/util/Locale;").ref;
            return FormatWithFormatter(context, locale,
    ...
    builder.StaticMethod(
        ...
        [](IntrinsicContext& context) {
            return FormatWithFormatter(context, context.arguments[0].ref,
                                       context.arguments[1].ref,
                                       context.arguments[2].ref);
        });
...
namespace ogplay::runtime::dexvm::intrinsics {
    namespace {
        ...
        [[nodiscard]] VmObjectRef StackTraceArray(
            Interpreter& vm, const std::uint64_t thread_id) {
            const auto snapshots = vm.StackSnapshot();
            const auto found = std::ranges::find_if(
                snapshots, [thread_id](const auto& stack) {
                    return stack.guest_thread_id == thread_id;
                });
            const auto count = found == snapshots.end() ? 0U
                                                        : found->frames.size();
            const auto array = vm.Model().NewObjectArray(
        ...
        [[nodiscard]] VmObjectRef EnsureCurrentThread(
            ...
            PropagateOutcome(vm, initialized);
            const auto group_field = vm.Linker().FindFieldRecursive(
                *group_class, "mMain", "Ljava/lang/ThreadGroup;");
            const auto& linked_group = vm.Linker().Field(*group_field);
    ...
    IntrinsicClassDecl Declare_java_lang_Thread() {
        ...
        builder.VirtualMethod("start", "()V", [fields](IntrinsicContext& context) {
            ...
            context.vm.Threads().Start(
                ...
                [fields](Interpreter& vm, const VmObjectRef thread,
                         const VmObjectRef throwable) {
                    const std::span<const VmValue> no_arguments;
                    IntrinsicContext field_context{vm, thread, no_arguments};
                    const IntrinsicCall field_call(field_context);
                    auto handler =
                        field_call.GetRef(fields.uncaught_handler, thread);
                    if (!handler.IsValid()) {
                        handler = field_call.GetRef(
                            fields.default_uncaught_handler);
                    }
                    ...
                    const auto index = vm.Linker().FindVtableIndex(
                        handler_class, "uncaughtException",
                        "(Ljava/lang/Thread;Ljava/lang/Throwable;)V");
                    if (!index.has_value()) return true;
                    // AOSP ignores failures raised by an uncaught-exception
                    // handler; invoking a selected handler completes dispatch.
                    const std::vector<VmValue> arguments{
                        VmValue::Ref(handler), VmValue::Ref(thread),
                        VmValue::Ref(throwable)};
                    static_cast<void>(vm.Call(
                        vm.Linker().Class(handler_class).vtable[*index],
                        arguments));
                    return true;
                }
            );
        ...
        // 返回该线程当前可观测的 DexVM Java 调用栈。
        builder.VirtualMethod(
            "getStackTrace", "()[Ljava/lang/StackTraceElement;",
            [fields](IntrinsicContext& context) {
                return VmValue::Ref(StackTraceArray(
        ...
        builder.StaticMethod(
            ...
            [](IntrinsicContext& context) {
                ...
                const auto constructor = vm.Linker().FindDirectMethod(
                    map_class, "<init>", "()V");
                const std::vector<VmValue> constructor_arguments{
                    VmValue::Ref(map)};
                PropagateOutcome(
                    vm, vm.Call(*constructor, constructor_arguments));
                const auto put_index = vm.Linker().FindVtableIndex(
                    map_class, "put",
                    "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;");
                for (const auto& thread : vm.Threads().Snapshot()) {
                    if (thread.status != VmThreadStatus::created &&
                        thread.status != VmThreadStatus::running) {
                        continue;
                    }
                    const auto stack = StackTraceArray(vm, thread.id);
                    const std::vector<VmValue> arguments{
                        VmValue::Ref(map),
                        VmValue::Ref(VmObjectRef{thread.object}),
                        VmValue::Ref(stack)};
                    PropagateOutcome(
                        vm, vm.Call(vm.Linker().Class(map_class)
                                        .vtable[*put_index],
                                    arguments));
                }
                return VmValue::Ref(map);
            });
        // 返回此线程显式设置的未捕获异常处理器。
        builder.VirtualMethod(
            ...
            [fields](IntrinsicContext& context) {
                return VmValue::Ref(
                    IntrinsicCall(context).GetRef(fields.uncaught_handler));
            });
        // 设置此线程专用的未捕获异常处理器，可传入 null 清除。
        builder.VirtualMethod(
            "setUncaughtExceptionHandler",
            "(Ljava/lang/Thread$UncaughtExceptionHandler;)V",
            [fields](IntrinsicContext& context) {
                IntrinsicCall call(context);
                call.SetRef(fields.uncaught_handler, call.Ref(0));
                return VmValue::Void();
            });
        // 返回进程内所有线程共用的默认未捕获异常处理器。
        builder.StaticMethod(
            "getDefaultUncaughtExceptionHandler",
            "()Ljava/lang/Thread$UncaughtExceptionHandler;",
            [fields](IntrinsicContext& context) {
                return VmValue::Ref(IntrinsicCall(context).GetRef(
                    fields.default_uncaught_handler));
            });
        // 设置进程内所有线程共用的默认未捕获异常处理器。
        builder.StaticMethod(
            "setDefaultUncaughtExceptionHandler",
            "(Ljava/lang/Thread$UncaughtExceptionHandler;)V",
            [fields](IntrinsicContext& context) {
                IntrinsicCall call(context);
                call.SetRef(fields.default_uncaught_handler, call.Ref(0));
                return VmValue::Void();
            });
        builder.FinalMethod("isAlive", "()Z", [](IntrinsicContext& context) {
            return VmValue::Int(context.vm.Threads().IsAlive(context.receiver) ? 1 : 0);
        });
        // 返回线程所属的线程组；已终止线程返回 null。
        builder.FinalMethod(
            "getThreadGroup", "()Ljava/lang/ThreadGroup;",
            [fields](IntrinsicContext& context) {
                IntrinsicCall call(context);
                if (call.GetInt(fields.has_been_started) != 0 &&
                    !context.vm.Threads().IsAlive(context.receiver)) {
                    return VmValue::Ref(VmObjectRef{});
                }
        ...
        // 生成包含线程名、优先级和线程组名的 API 19 文本。
        builder.OverrideMethod(
            "toString", "()Ljava/lang/String;",
            [fields](IntrinsicContext& context) {
                IntrinsicCall call(context);
                const auto name = context.vm.StringUtf8(call.GetRef(fields.name));
                const auto group = call.GetRef(fields.group);
                std::string group_name;
                if (group.IsValid()) {
                    const auto index = context.vm.Linker().FindVtableIndex(
                        context.vm.Model().ObjectClass(group), "getName",
                        "()Ljava/lang/String;");
                    const std::vector<VmValue> arguments{VmValue::Ref(group)};
                    const auto outcome = context.vm.Call(
                        context.vm.Linker()
                            .Class(context.vm.Model().ObjectClass(group))
                            .vtable[*index],
                        arguments);
                    PropagateOutcome(context.vm, outcome);
                    group_name = context.vm.StringUtf8(outcome.value.ref);
                }
                return VmValue::Ref(context.vm.NewStringUtf8(
                    "Thread[" + name + "," +
                    std::to_string(call.GetInt(fields.priority)) + "," +
                    group_name + "]"));
            });
...
IntrinsicClassDecl Declare_java_lang_ThreadGroup() {
    auto builder = IntrinsicClassBuilder::Class(
    ...
    builder.ClassInitializer(
        [name, parent, system, main](IntrinsicContext& context) {
            IntrinsicCall call(context);
            const auto system_group =
                context.vm.NewIntrinsicInstance("Ljava/lang/ThreadGroup;");
            call.SetRef(system, system_group);
            call.SetRef(parent, system_group, VmObjectRef{});
            call.SetRef(name, system_group,
                        context.vm.NewStringUtf8("system"));
            const auto main_group =
                context.vm.NewIntrinsicInstance("Ljava/lang/ThreadGroup;");
            call.SetRef(main, main_group);
            call.SetRef(parent, main_group, system_group);
            call.SetRef(name, main_group, context.vm.NewStringUtf8("main"));
            return VmValue::Void();
        });
    builder.FinalMethod(
        "getName", "()Ljava/lang/String;", [name](IntrinsicContext& context) {
            return VmValue::Ref(IntrinsicCall(context).GetRef(name));
        });
    builder.VirtualMethod("activeCount", "()I", [](IntrinsicContext& context) {
        std::int32_t count = 0;
        for (const auto& thread : context.vm.Threads().Snapshot()) {
            if (thread.status == VmThreadStatus::created ||
                thread.status == VmThreadStatus::running) {
    ...
    builder.VirtualMethod(
        ...
        [](IntrinsicContext&) -> VmValue {
            throw VmJavaThrow{
                "Ljava/lang/UnsupportedOperationException;",
                "bounded ThreadGroup has no stderr uncaught handler"};
        });
    return std::move(builder).Build();
}
...
// Throwable Java behavior and fields come from BootDex; only VM stack primitives remain.
namespace ogplay::runtime::dexvm::intrinsics {
void AppendJavaLangThrowables(std::vector<IntrinsicClassDecl>& catalog) {
    auto builder = IntrinsicClassBuilder::Class("Ljava/lang/Throwable;");
    builder.StaticMethod("nativeFillInStackTrace", "()Ljava/lang/Object;",
        [](IntrinsicContext& c) { return VmValue::Ref(c.vm.CaptureThrowableStack()); },
        kAccPrivate | kAccNative);
    builder.StaticMethod("nativeGetStackTrace", "(Ljava/lang/Object;)[Ljava/lang/StackTraceElement;",
        [](IntrinsicContext& c) { return VmValue::Ref(c.vm.MaterializeThrowableStack(c.arguments[0].ref)); },
        kAccPrivate | kAccNative);
