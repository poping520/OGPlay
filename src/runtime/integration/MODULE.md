...
- `BindJniGuestCoreSlots` 只绑定已有真实 M3 语义的 20 个 JNIEnv 基础 slot 与 4 个
  ...
  engine，`GetArrayLength` 只解析统一环境中的 primitive array identity；错误 return kind、
  class、method、handler 或 array reference 明确失败，
