...
void InstallAndroidGuestFrameworkPlatform(JniClassRegistry& classes) {
    // ViewRoot has no VM implementation yet. Other platform classes are
    // published by DexVmGuestBridge from the linked class directory.
    static_cast<void>(classes.RegisterClass({"java/lang/Object", {}, {}, {}}));
