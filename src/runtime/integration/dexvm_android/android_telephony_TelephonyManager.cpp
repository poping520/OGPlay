...
Decl Declare_android_telephony_TelephonyManager(const Context& context) {
    ...
    builder.Virtual("getNetworkOperatorName", "()Ljava/lang/String;", handlers.handler_android_telephony_empty_string);
    builder.Virtual("getNetworkCountryIso", "()Ljava/lang/String;", handlers.handler_android_telephony_empty_string);
    builder.Virtual("getSimCountryIso", "()Ljava/lang/String;", handlers.handler_android_telephony_empty_string);
    builder.Virtual("getSimOperator", "()Ljava/lang/String;", handlers.handler_android_telephony_empty_string);
    builder.Virtual("getSimOperatorName", "()Ljava/lang/String;", handlers.handler_android_telephony_empty_string);
    builder.Virtual("isNetworkRoaming", "()Z", handlers.handler_android_telephony_false);
