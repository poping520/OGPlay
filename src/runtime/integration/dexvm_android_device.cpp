...
void RegisterDeviceServices(dx::IntrinsicRegistry& registry,
  ...
  registry.Register("android.wifi.is_enabled",
  ...
  registry.Register("android.wifi.set_enabled", [](dx::IntrinsicContext &) {
  ...
  registry.Register("android.wifi.create_lock", [](dx::IntrinsicContext &call) {
  ...
  registry.Register("android.looper.noop",
                    [](dx::IntrinsicContext &) { return dx::VmValue::Void(); });
  registry.Register("android.handler.init",
                    [](dx::IntrinsicContext &) { return dx::VmValue::Void(); });
    ...
    const auto index = linker.FindVtableIndex(handler_class, "handleMessage",
    ...
    const auto outcome =
        vm.Call(linker.Class(handler_class).vtable[*index],
  ...
  registry.Register("android.handler.post", [](dx::IntrinsicContext &call) {
        auto& vm = call.vm;
        auto& linker = vm.Linker();
  ...
  registry.Register("android.timer.cancel", [context](dx::IntrinsicContext &) {
  ...
  registry.Register(
      "android.url_encoder.encode", [](dx::IntrinsicContext &call) {
        ...
        if (charset != "UTF-8" && charset != "UTF8") {
          throw dx::VmJavaThrow{"Ljava/io/UnsupportedEncodingException;",
                                charset};
        }
